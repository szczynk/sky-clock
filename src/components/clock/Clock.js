...
export default function render ({ date }) {
    ...
    return (<div className="clock">
        <div id="sky-standard-time" className="clock-display sky"><span className="label">Sky Time:</span> <Time hour={skyHour} minute={skyMinutes} second={skySeconds}></Time></div>
